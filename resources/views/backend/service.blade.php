                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($services as $service)
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('uploads/service/'.$service->icon)}}" class="img img-size-64"> </td>
                                    <td><a href="{{route('backend.delete_service',$service->id)}}"> <span  class="fa fa-trash"></span></a></td>
                                </tr>
    ...
    <div class="modal " tabindex="-1" role="dialog" id="new_coutry_modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('backend.save_new_service')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
